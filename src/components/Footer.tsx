  ...
  <footer className="bg-foreground text-primary-foreground mt-12 sm:mt-20">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
        ...
        <div>
          <h4 className="font-heading text-base sm:text-lg font-semibold mb-4">Categorías</h4>
        ...
        <div>
          <h4 className="font-heading text-base sm:text-lg font-semibold mb-4">Navegación</h4>
          <ul className="space-y-2 text-sm text-primary-foreground/60">
        ...
        <div>
          <h4 className="font-heading text-base sm:text-lg font-semibold mb-4">Contacto</h4>
      ...
      <div className="border-t border-primary-foreground/10 mt-8 sm:mt-12 pt-6 text-center text-xs sm:text-sm text-primary-foreground/40 flex flex-col sm:flex-row items-center justify-center gap-2">
